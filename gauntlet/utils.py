...
def price_impact_size_cowswap(token_in: str, token_in_decimals: int, token_out: str, token_out_decimals: int, target_price_impact: float, rtol=5e-2):
    cg = CoinGecko()
    ...
    min_sz = 0
    max_sz = 300_00_000_000 / spot_in # hundred mill as a loose upper bound seems okay?
    iters = 0
    price_impact = 1
...
if __name__ == '__main__':
    ...
    addr_to_sym = {
        usdc: "usdc", link: "link", aave: "aave", crv: "crv", weth: "weth", wbtc: "wbtc"
    }
