...
If the value of WETH drops such that the value of Eve's collateral is worth $165. At this point, Eve's LTV is $\frac{160}{165} = 0.969$, which is larger than her LLTV. This means she is eligible to be liquidated. A liquidator can repay $150 USDC of her debt to claim $150 \times (1 + 10\%) = 165$. At the end of this liquidation, Eve will have $0 in collateral and $10 in debt. Since this debt is uncollateralized, the debt is realized instantaneously and split between Alice and Bob equally since they both supplied the same amount to begin with. Their supply positions are now worth $95 USDC.
